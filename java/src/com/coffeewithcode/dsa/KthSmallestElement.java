...
class KthSmallestElement
{
	...
	int kthSmallest(int arr[], int l, int r, int k)
	{
		...
		if (k > 0 && k <= r - l + 1)
		{
			...
			System.out.println("array after position-==="+Arrays.toString(arr));

			System.out.println("position is "+pos+"  value is ="+arr[pos]);
	...
	int randomPartition(int arr[], int l, int r)
	{
		...
		System.out.println("randon=="+pivot);
		swap(arr, l + pivot, r);
